...
def identity(figi="F1", share=None, st="PRIVATE", st2="Preferred Stock", ticker="RGBPP"):
...
@pytest.mark.parametrize("ids",[[],[identity("F1"),identity("F2")],[identity(st="PUBLIC")],[identity(st2="Common Stock")],[identity(ticker="OTHER")]])
...
def test_policy431_reuses_policy429_verified_cache():
